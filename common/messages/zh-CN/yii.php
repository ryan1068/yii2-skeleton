...
return [
    ...
    '(not set)' => '(未设置)',
    'An internal server error occurred.' => '好像出了一点问题，请您稍后重试^_^',
    'The object being updated is outdated.' => '该数据已被更新，请重新加载...',
    ...
    '{delta, plural, =1{1 day} other{# days}}' => '{delta, number,00}',
    '{delta, plural, =1{1 hour} other{# hours}}' => '{delta, number,00}',
    '{delta, plural, =1{1 minute} other{# minutes}}' => '{delta, number,00}',
    '{delta, plural, =1{1 month} other{# months}}' => '{delta, number,00}',
    '{delta, plural, =1{1 second} other{# seconds}}' => '{delta, number,00}',
    '{delta, plural, =1{1 year} other{# years}}' => '{delta, number,00}',
